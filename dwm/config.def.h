...
static const char *colors[][3]      = {
    ...
    [SchemeTest] = { col_gray3, col_gray1, col_gray2 },
...
static const char *dmenucmd[]    = { "dmenu_run", "-i", "-p", " Run:", "-m", dmenumon, "-fn", dmenufont, "-nb", col_gray1, "-nf", col_gray3, "-sb", col_black, "-sf", col_gray4, "-hp", run_application_preferences, NULL };
