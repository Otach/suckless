...
static const char *dmenucmd[]   = { "dmenu_run", "-i", "-p", "Run:", "-m", dmenumon, "-fn", dmenufont, "-nb", col_gray1, "-nf", col_gray3, "-sb", col_black, "-sf", col_gray4, "-hp", "firefox-developer-edition,pavucontrol,pcmanfm,thunderbird,nvidia-setting,smerge,subl,virt-manager", NULL };
...
static const char *usbmount[]	= { "sh", "/home/mason/suckless/dmenu/scripts/usbmount.sh", NULL };
static const char *usbumount[]  = { "sh", "/home/mason/suckless/dmenu/scripts/usbumount.sh", NULL };
...
static Key keys[] = {
	...
	{ MODKEY|ShiftMask,				XK_g,		setmfact, 		{.f = -0.01} },
	...
	{ MODKEY|ShiftMask,				XK_u,		spawn,			{.v = usbumount } },
